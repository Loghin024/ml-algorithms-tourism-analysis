...
def preprocess_and_engineer_features(data, country):
    """
    Filters the dataset for a specific country and performs feature engineering.
    """
...
def train_and_evaluate_naive_bayes(data):
    ...
    # stratified split into training and testing sets (80%-20%)
...
def main(file_path, country):
    ...
    country_data, le_category = preprocess_and_engineer_features(data, country)
